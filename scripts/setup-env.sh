...
DATABASE_HOST="${DATABASE_HOST:-118.145.179.97}"
DATABASE_PORT="${DATABASE_PORT:-5432}"
DATABASE_NAME="${DATABASE_NAME:-offergpt}"
DATABASE_USER="${DATABASE_USER:-offergpt}"
DATABASE_PASSWORD="$(read_required_secret "DATABASE_PASSWORD" "请输入 PostgreSQL 密码: ")"
DATABASE_URL="${DATABASE_URL:-postgresql://$DATABASE_USER:$DATABASE_PASSWORD@$DATABASE_HOST:$DATABASE_PORT/$DATABASE_NAME}"
REDIS_PASSWORD="$(read_required_secret "REDIS_PASSWORD" "请输入 Redis 密码: ")"
TOS_ACCESS_KEY_ID="${TOS_ACCESS_KEY_ID:-${VOLCENGINE_ACCESS_KEY_ID:-}}"
TOS_SECRET_ACCESS_KEY="${TOS_SECRET_ACCESS_KEY:-${VOLCENGINE_SECRET_ACCESS_KEY:-}}"
